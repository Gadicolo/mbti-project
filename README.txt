...
Pour v0.3:
  ...
  - Améliorer le prototype de logo (ou même le terminer)
    ...
    > Version plus détaillée pour l'afficher en grand.

Si le contenu de la version 0.3 est créé, le mettre directement dans le répertoire GitHub et bien noter v0.2.x dans les mots sur la mise-à-jour + éditer le fichier README.txt. La v0.3 est une version finale des objectifs donnés.
